...
public class Reception extends JFrame {
	...
	public Reception(){
		...
		btnNewCustomerForm.setForeground(Color.WHITE); // Fixed color to be visible
		...
		btnNewButton.setForeground(Color.WHITE); // Fixed color to be visible
		...
		btnNewButton_2.setForeground(Color.WHITE); // Fixed color to be visible
		...
		btnNewButton_3.setForeground(Color.WHITE); // Fixed color to be visible
		...
		btnManagerInfo.setForeground(Color.WHITE); // Fixed color to be visible
		...
		btnNewButton_4.setForeground(Color.WHITE); // Fixed color to be visible
		...
		btnNewButton_5.setForeground(Color.WHITE); // Fixed color to be visible
		...
		btnNewButton_6.setForeground(Color.WHITE); // Fixed color to be visible
		...
		btnPickUpSerice.setForeground(Color.WHITE); // Fixed color to be visible
		...
		btnSearchRoom.setForeground(Color.WHITE); // Fixed color to be visible
		...
		btnNewButton_7.setForeground(Color.WHITE); // Fixed color to be visible
